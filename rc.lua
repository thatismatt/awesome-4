...
bindings.keys = gears.table.join(
   ...
   awful.key({ modkey,           }, "j",       focus_raise(1),                                         { description = "Next",                  group = "client" }),
   awful.key({ modkey,           }, "k",       focus_raise(-1),                                        { description = "Previous",              group = "client" }),
   ...
   awful.key({ modkey, "Shift"   }, "j",       function () awful.client.swap.byidx(  1) end,           { description = "Move next",             group = "client" }),
   awful.key({ modkey, "Shift"   }, "k",       function () awful.client.swap.byidx( -1) end,           { description = "Move previous",         group = "client" }),
...
bindings.client.keys = gears.table.join(
   ...
   awful.key({ modkey, "Shift"   }, "h",      tag_prev,                                                   { description = "Previous tag", group = "client" }),
